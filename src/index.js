...
console.log("[Question #7]: ", student); // should print John
...
console.log("[Question #8]: ", fruits); // should print John
...
if (temperature > 28) {
  console.log("[Question #14]: ", "It's hot!");
...
if (booleanVar) {
  ...
  console.log("booleanVar is falsey");
}
...
if (temperature > 25) {
  ...
  console.log("[Question #50]: ", console.log("Just right")); // should print Just right!
}
...
if (!isVisible) {
  ...
  console.log("[Question #68]: ", isVisible);
}
...
if (book !== "isbn") {
  console.log("[Question #98]: ", "The book dont has a 'isbn' property.");
}
//

// 99. Calculate the difference between 'circlePerimeter' and 'squareArea' and store it in a variable named 'shapeDifference'.
const shapeDifferent = squareArea - circlePerimeter;

console.log("[Question #99]: ", shapeDifferent);
